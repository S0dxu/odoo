      ...
      .then((readData) => {
        ...
        readData.result.forEach((record) => {
          ...
          if (
            ...
            pushDesktopNotifications(record, `Email unread${textDiffInDays === "" ? "" : " for"} ${textDiffInDays} ${textDiffInDays === "" ? "" : "days"}`, typeOfOpp)
            return;
          }
          ...
          if (
            ...
            pushDesktopNotifications(record,`Customer inactivity (more than ${textDiffInDays} days)`, typeOfOpp);
            return;
          }
          ...
          if (
            ...
            pushDesktopNotifications(record, "Inactivity by the company (more than 7 days)", typeOfOpp);
            return;
          }
        });
      })
          ...
          setTimeout(() => {
              ...
              if (suggestions.length > 0) {
                  suggestions.forEach((el) => {
                      ...
                      if (suggestionText.includes(`Create "${name.toUpperCase()}"`)) {
                          el.click();
                      }
                  });
              }
  ...
  function inviaEmailDiInteresseIT() {
    ...
    setTimeout(() => {
      ...
      if (modal) {
        ...
        if (paragraph) {
          paragraph.innerHTML = `Ciao ${clientName},<br>Hai avuto modo di vedere la mia mail precedente?<br>A presto,<br>221e Team<br>`;
